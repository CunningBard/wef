...
export async function transformImage(_ctx, input) { const bytes = new Uint8Array(input.body); bytes[0] ^= 0xff; return { mimeType: input.mimeType ?? 'image/png', body: input.body }; }
